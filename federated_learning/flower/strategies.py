...
class FedAvg(fl.server.strategy.FedAvg):
    def __init__(self, 
        ...
        *args, **kwargs, 
        ...
        self.wandb_name = f"{self.arguments.args_dict.fl_training.wandb_name}__num_workers_{self.arguments.num_clients}__num_selected_workers_{self.arguments.num_clients}__num_poisoned_workers_{self.arguments.get_num_poisoned_workers()}__poison_amount_ratio_{self.arguments.args_dict.narcissus_gen.poison_amount_ratio}__local_epochs_{self.arguments.args_dict.fl_training.local_epochs}__target_label_{self.arguments.args_dict.fl_training.target_label}__poisoned_workers_{self.arguments.args_dict.fl_training.poisoned_workers}__n_target_samples_{self.arguments.args_dict.fl_training.n_target_samples}__multi_test_{self.arguments.args_dict.narcissus_gen.multi_test}__patch_mode_{self.arguments.args_dict.narcissus_gen.patch_mode}__max_gen_round_{self.arguments.args_dict.narcissus_gen.gen_round}__gen_trigger_interval_{self.arguments.args_dict.fl_training.gen_trigger_interval}__narcissus_optimizer_{self.arguments.args_dict.narcissus_gen.optimizer}__exp_{self.arguments.args_dict.fl_training.experiment_id}"
