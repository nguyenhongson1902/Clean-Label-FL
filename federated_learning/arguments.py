# from .nets import FashionMNISTCNN, Cifar10CNN
# from .worker_selection import BeforeBreakpoint, AfterBreakpoint, PoisonerProbability
from .nets import ResNet18_201, ResNet18
import torch
import json
...
class Arguments():
    def __init__(self, logger, config_filepath="./config/test.json"):
        ...
        self.device = "cuda" if torch.cuda.is_available() and self.get_cuda() else "cpu"
